...
> Later I also figured out how one could create a very efficient share system between host and VM with zvol and some simple scripts to synchronize data between zvol and share directory, to only sync data if this zvol is not mounted on the guest.
---
