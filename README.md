...
- [**ZGuide: Window11 VM on ZFS Zvol**](https://github.com/jimmykallhagen/nordix-vm/blob/main/nordix-ZGuide-win11-zfs-setup.md) - Nordix Zguide to run fast Windows11 VM on ZFS
----
