...
All original Nordix software - including but not limited to the Yggdrasil desktop
environment, Nordix server systems, configuration files, shell scripts, GUI tools,
shaders, themes, and ISO images - is licensed under the PolyForm Noncommercial
License 1.0.0 with the additional terms described below.

Third-party components included in Nordix distributions retain their original
licenses (e.g., the Linux kernel under the GPL-2.0, Hyprland under the BSD-3 clause, and all other projects under their respective licenses). This license applies only to original works created by Jimmy Källhagen for the Nordix project.

Required Notice: Copyright (c) 2025 Jimmy Källhagen
Required Notice: Nordix and Yggdrasil are trademarks of Jimmy Källhagen
...
Nordix and Yggdrasil are registered trademarks of Jimmy Källhagen. This license
does not grant any rights to use these trademarks. Unauthorized use of the
Nordix or Yggdrasil names, logos, or branding in any commercial or promotional
context is prohibited without prior written consent from the licensor.

Redistribution of modified versions of the software must not use the Nordix or
Yggdrasil names or trademarks without explicit permission, to avoid confusion
about the origin or endorsement of such modified versions.

---

## Scope of This License

This license covers all original Nordix works, including but not limited to:

- **Yggdrasil** — the Nordix desktop environment and all its components
- **Nordix Server Systems** — server configurations and tools
- **Nordix CLI Tools** — all command-line utilities (nordix-cli-*)
- **Nordix GUI Tools** — all graphical configuration tools
- **Nordix Shaders** — all Nordix-branded fragment shaders (Nordix-*.frag)
- **Configuration Files** — all Nordix-specific system configurations
- **ISO Images** — pre-built Nordix system images
- **Documentation** — all Nordix-specific documentation
- **Installer and Build Scripts** — all scripts used to assemble Nordix

Third-party software distributed alongside Nordix retains its original license.
When in doubt, check the license header in each file.

---

## Commercial Licensing

Commercial use of Nordix software — including but not limited to selling
computers with Nordix pre-installed, selling Nordix ISO images, offering
Nordix as a service, or incorporating Nordix components into commercial
products — requires a separate commercial license agreement with the licensor.

### How to Obtain a Commercial License

For commercial licensing inquiries, partnership opportunities, or OEM
agreements, contact:
...
Commercial licenses can be tailored to your needs, including:

- **OEM License** — for hardware manufacturers who want to ship Nordix
  pre-installed on their systems
- **Reseller License** — for distributors selling Nordix ISO images or
  pre-configured storage media
- **Enterprise License** — for organizations deploying Nordix internally
  at scale
- **Partner License** — for businesses offering Nordix-based services or
  solutions to their own customers

---

## SPDX License Header for Source Files
...
```
 ...
 ## For C and Shader files (.frag, .glsl):
